...
print("\n\n2. Cadastro Simples:\n") #Solicite o nome, a idade e a cidade do usuário. Ao final, exiba a frase: Seu nome é [nome], você tem [idade] anos e mora em [cidade].\n")
